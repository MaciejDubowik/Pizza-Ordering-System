...
public class OrderSummaryOutSceneController implements Initializable {
    ...
    public void saveToFile() throws IOException {
        try (BufferedWriter bw = new BufferedWriter(new FileWriter("src/order.txt", true))) {
            ...
            bw.write("DOSTAWA");
            bw.newLine();
            bw.write(nameLabel.getText());
            bw.newLine();
            bw.write(streetLabel.getText());
            bw.newLine();
            bw.write(cityLabel.getText());
            bw.newLine();
            bw.write("------------------------------");
            bw.newLine();
            bw.write("Rozmiar:");
    ...
    public void displayName(String nameNsur) {
        nameLabel.setText(nameNsur);
    }

    public void displayStreet(String streetNnb) {
        streetLabel.setText(streetNnb);
    }

    public void displayCity(String postNcity) {
        cityLabel.setText(postNcity);
    }
}
